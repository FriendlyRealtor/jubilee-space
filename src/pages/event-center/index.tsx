...
export const EventCategories = [
  ...
  { value: 'realtor_networking', label: 'Agent Networking' },
  ...
  { value: 'realtor_training_sessions', label: 'Agent Training Sessions' },
  ...
  { value: 'realtor_appreciation_dinners', label: 'Agent Appreciation Dinners' },
