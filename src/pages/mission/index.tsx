...
const MissionPage = () => {
  return (
    <Container
      seoProps={{
        title: 'JubileeSpace - Mission Statement',
      }}
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            At JubileeSpace, we're your trusted partner on the path to homeownership. Our dedication
            is to help individuals and families turn their homeownership dreams into reality within
            the next 3-5 years.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          <div className="flex items-center mb-4">
            <div className="w-1/4">
              <Image
                src={montrell}
                alt="JubileeSpace Agent Montrell"
            ...
            <div className="w-3/4 pl-4">
              ...
              <p className="text-gray-600 mt-4">
                ...
                instrumental in shaping JubileeSpace into the trusted entity it is today.
              </p>
              <p className="text-gray-600 mt-4">
